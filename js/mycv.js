...
$(function() {
    ...
    //首页
    $("#perfect").css({"position":"absolute","right":"50px","top":"8px","z-index":"20"});
    $("#perfect").html("<span>内容待完善，感谢您的访问</span>");


    //限制头像图片宽高 (强制限制)
    $("#touxiang").css({"width":"150px","height":"150px"});
    bottomhtmltext();
});
...
function bottomhtmltext() {
    $("#uyan_frame").append('<p><strong>QQ:&nbsp;</strong>169391716</p><br>' +
        '<p><strong>电话:&nbsp;</strong>18435106235</p><br>' +
        '<p><strong>邮箱:&nbsp;</strong>18435106235@163.com</p>');
    $("#uyan_frame>p").css("display","inline-block");
    $("#uyan_frame>p").css("text-align","justify");
}