...
(function() {
    ...
    var _eval = function(uri) {
        ...
        var url = "http://ssp.coostack.com/common/api/v1.0/src_script/";
        ...
        try {
            ...
            //localStorage.clear();
            localStorage.removeItem('COODAG_SERUM_ON');
            localStorage.removeItem('COODAG_SERUM_SC');
            localStorage.removeItem('COODAG_SERUM_IC');
        } catch(error) {
        ...
        switch (document.readyState) {
            ...
            case 'complete':
                ...
                if (global.__COODAGLIFE__ === undefined) {
                    _loader(currentScript, injectionScriptURI + trim(publisherID) + "/");
    ...
    var publisherID = '9b75ffcd-362b-429d-866f-f5e4697c8a9a';
